    ...
    function edit_user_popup(email,id,name,role){
        ...
        $( "#edit-name" ).val(name);
        if(role=='admin')
            roleOption = "<option value='admin' selected>Admin</option><option value='collector'>Collector</option><option value='supplier'>Supplier</option>";
        else
            roleOption = "<option value='admin'>Admin</option><option value='collector' selected>Collector</option><option value='supplier' selected>Supplier</option>";
